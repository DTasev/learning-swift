...
class AnimalTableVC: UITableViewController {
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCellWithIdentifier("AnimalCell", forIndexPath: indexPath) as! AnimalCell
        
        let rightText = categoryItems[indexPath.section][indexPath.row]
        
        cell.animalName.text = rightText
        cell.photo.image = UIImage(named: "\(rightText).jpg")
